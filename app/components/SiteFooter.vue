  ...
  <footer>
    <div class="wrap">
      <div class="f-grid">
        ...
        <div class="f-col">
          <h4>案例</h4>
          <NuxtLink to="/case-customs">报关单自动化</NuxtLink>
          <NuxtLink to="/cases#market">市场调研</NuxtLink>
          <NuxtLink to="/cases#competitor">竞品拆解</NuxtLink>
          <NuxtLink to="/cases#influencer">网红调研</NuxtLink>
        </div>
      </div>
      <div class="f-bottom">
